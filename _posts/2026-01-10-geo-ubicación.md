...
<a id="f3"></a>
{% include  image.html url="/img/geoloc/sextante_marino.svg" description="Figura 1. Esquema básico de un sextante marino. Fuente: ver referencias 3 y 4 " width=100 %}
