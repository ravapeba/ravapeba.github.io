...
$$x_s=\frac{l}{\tan\alpha} \quad \small \textbf{[AI.3]$$
...
$$
v_{xs}=\frac{d{xs}}{dt}=\frac{\pi l\sinh\cos\varphi\cos\delta}{720\sin^{2}\alpha(\varphi,\delta,h)\sqrt{1-\sin^{2}\alpha(\varphi,\delta,h) \quad}}  \quad \frac{mm}{min} \quad \small \textbf{[AI.4]}
$$  
...
v_{xs_1}(\varphi,\delta,h)+\frac{t_2-t_1}{2}\left(v_{xs_2}(\varphi,\delta,h)-v_{xs_1}(\varphi,\delta,h)\right) \quad mm \quad \small \textbf{[AI.5]}
$$
