...
<a id="f3"></a>
{% include  image.html url="/img/serie_vostok1.svg" description="Figura 3. Evolución de la temperatura media centenal (anomalías respecto al promedio del último siglo), según el testigo de hielo de Vostok, durante los últimos 420.000 años. Fuente: ver referencias 3 y 4 " %}
