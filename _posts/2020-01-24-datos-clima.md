...
<a id="f1"></a>
{% include image.html url="/img/serie_hadley.svg" description="Fig 1. Evolución de la temperatura en superficie (valor medio global / anomalías respecto a 1961-1990) entre los años 1850 y 2024. Fuente: HadCRUT5 near surface temperature data set, Met Office Hadley Centre (referencia 1)." %}
