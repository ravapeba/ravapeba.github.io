...
<a id="f1"></a>
{% include image.html url="/img/serie_had2.svg" description="Fig 1. Evolución de la temperatura media global (anomalías respecto a 1961-1990) entre los años 1850 y 2024. Fuente: HadCRUT5 near surface temperature data set, Met Office Hadley Centre (referencia 1)." %}
...
<a id="f2"></a>
{% include image.html url="/img/serie_mann_hadley3.svg" description="Fig 2. Evolución de la temperatura media global (anomalías respecto a 1961-1990) entre los años 200 y 2024. Fuente: ver referencias 1 y 2." %}
