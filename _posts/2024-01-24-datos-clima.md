...
En el gráfico inferior de la figura [3](#f3) se constata que durante todo el periodo los niveles promedio de CO<sub>2</sub> están claramente por debajo del promedio del último siglo (320 ppm), no superándose en ningún momento la concentración media de 300 ppm. Para esta serie, la máxima amplitud de los cambios de temperatura media centenal entre periodos glaciales e inter-glaciales es de unos 11 ºC (con rango  [-8,3] ºC respecto a la temperatura media del último siglo en la estación de Vostok (-54.35ºC), según su registro instrumental (ver referencia [5](#5)) combinado con datos del testigo de hielo (hay que tener en cuenta Vostok es una estación con elevadas continentalidad y latitud, factores que llevan al extremo la variabilidad térmica). El rango de variabilidad comentado, asociado al forzamiento orbital o astronómico del clima (eficiente a escalas de miles de años), es muy superior al rango de anomalías globales (figura [2](#f2)), fruto principalmente del forzamiento natural del clima (asociado a cambios en la actividad solar y volcánica, procesos de interacción océano atmósfera, etc.), a escalas temporales menores. No obstante la comparación, aunque tentadora, no es justa, pues la serie de Vostok es una serie de temperaturas locales y la de Mann es una serie de temperaturas medias globales. Además, las variaciones de gran amplitud en la serie de Vostok ocurren en escalas temporales de milenios, mientras que en la serie de la figura [2](#f2), en su parte final, se aprecian variaciones importantes en una escala temporal de decenios. Las pendientes máximas de la curva de temperaturas de Vostok, que no pueden apreciarse salvo a escala de milenios en la figura [3](#f3), se dan en las transiciones de un periodo glacial al subsiguiente inter-glacial, siendo del orden de unos 11 ºC en 10 milenios (ritmo promedio de ~0.1 ºC cada 100 años). Este ritmo de cambio es muy inferior al de la temperatura global promedio del último siglo (~0.4ºC, [ver serie](https://ravapeba.github.io/img/serie_mann_hadley100.svg)), aún a pesar de los factores de extremas continentalidad y latitud de la estación de Vostok .
